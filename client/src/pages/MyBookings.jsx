...
const MyBookings = () => {
  ...
  return (
      <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
          <Title title="My Bookings" subTitle='Easily manage your past, current, and upcoming hotel reservations in oane place. Plan your trips seamlessly with just a few clicks ' align='left' />
          ...
          <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            <div key={booking._id} className="mb-6 grid md:grid-cols-[3fr_2fr_1fr] gap-4">
                {/* Hotels Column */}
                ...
                {/* Date & Timings Column */}
                <div className='flex flex-row gap-8 mt-3 md:mt-0'>
                <div>
                    <p>Check-In:</p>
