...
const AllRooms = () => {
  ...
  return (
      <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:mx-24 xl:px-32'>
          <div>
              <div className='flex flex-col items-start text-left'>
                  <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms </h1>
                  <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantage of our linited-time offers and special package to enhance your stay and create unforgettable memories.</p>
              </div>
                      ...
                      <div className='flex items-center gap-1 text-gray-500 mt-2 text-sm'>
                          ...
                          <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                              {room.amenities.map((item, index) => (
                                  <div key={index} className='flex flex-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'>
