  ...
  return room && (
      <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
          ...
          <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
              <p> Guests will be alloted on the ground floor according to Availabilitty.You get a comfortable 2 bedroom apartment has a true city feeling.</p>
          </div>
          ...
          <div className='flex flex-col items-start gap-4 '>
              ...
              <button className='px-5 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointer'>Contact Now</button>
          </div>
    </div>
  )
}
